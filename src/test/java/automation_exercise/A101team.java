...
public class A101team extends TestBaseBeforeAfter {
    /*
...
*/
    ...
    public void test() throws InterruptedException {
        ...
        Thread.sleep(1000); // ILCE SECIMINDEN SONRA EN AZ 1 SANIYE THREAD OLMAZSA SECIM TEST  YAPAMIYOR !!!!
        WebElement mah = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".js-district")));
        select = new Select(mah);
        // ilçe seçimi yapılmadan mahalle seçimi alanı seçilemediği (dropDown içerisindeki obejeler yüklenemedi
        // ve selected yapılamadığını farkettik)
        // bundan dolayı elementToBeClickable kullanıldı. Fakat hala StaleElementReferenceException hatası alınıyordu.
        // Bundan dolayı aşağıda try-catch bloğuna ve for döngüsüne alındı
