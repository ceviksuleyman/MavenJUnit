 ...
 */
    ...
    private void table() {
        //4 table body’sinde bulunan toplam sutun(column) sayısını bulun.
        ...
        basliklar.forEach(t -> System.out.print(t + " "));
        System.out.println("\n");
    }
    ...
    private void printColumns() {
        //14   // 4 un aynisi table body’sinde bulunan toplam sutun(column) sayısını bulun.
